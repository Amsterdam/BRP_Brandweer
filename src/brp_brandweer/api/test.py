...
from api.app import app as main_app, get_bag_id_info
from api.config import config, check_env_vars, required_env_vars
...
def test_age_categories():
    ...
    for i in [ -1, 999999]:
        assert _get_age_category(i) == None
